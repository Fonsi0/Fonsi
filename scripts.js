...
function determinePlayerType() {
    ...
    if (values.utangNaLoob > 30) {
        description += 'You are a person who values "utang na loob" (debt of gratitude) highly. You are generous and believe in supporting others who have helped you in the past.\n\n';
    } else {
    ...
    if (values.pakikisama > 30) {
        description += 'You place a high value on "pakikisama" (social harmony). You strive to maintain good relationships and make efforts to fit in and help others.\n\n';
    } else {
    ...
    if (values.kagandahangLoob > 30) {
        description += 'You exhibit a strong sense of "kagandahang loob" (kindness). You are considerate and always willing to lend a helping hand to others.\n\n';
    } else {
